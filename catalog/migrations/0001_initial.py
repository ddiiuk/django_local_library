# Generated by Django 5.1.11 on 2026-01-07 13:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('m', 'Maintenance'), ('o', 'On loan'), ('a', 'Available'), ('r', 'Reversved')], default='m', help_text='Book availibility', max_length=1)),
